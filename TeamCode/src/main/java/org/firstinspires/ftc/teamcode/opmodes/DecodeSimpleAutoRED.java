...
@Autonomous(name = "DECODE Competition Auto RED", group = "Competition")
public class DecodeSimpleAutoRED extends OpMode {
        ...
        switch (state) {
            ...
            case READ_PATTERN:
                ...
                if (timer.seconds() < 0.5) {
                    ...
                    if (obeliskPattern == 21) shotSequence = "RLL";
                    else if (obeliskPattern == 22) shotSequence = "LRL";
                    else if (obeliskPattern == 23) shotSequence = "LLR";
                    else shotSequence = "RLL";
